 ...
 * Get item from cache
 */
- (NSData*)get:(NSString*)key error:(NSError**)error;
/**
 * Put item into cache
 */
- (NSString*)put:(NSString*)key content:(NSData*)content error:(NSError**)error;
@end
...
- (ProxyProxyResult*)rewriteIndex:(NSString*)fullURL;
/**
